...
urlpatterns = [
    # Подборки задач
    path('collections/', views.collection_list, name='list'),
    path('collections/create/', views.collection_create, name='create'),
    path('collections/<int:collection_id>/edit/', views.collection_edit, name='edit'),
    path('collections/<int:collection_id>/', views.collection_detail, name='detail'),
    path('collections/<int:collection_id>/start/', views.start_collection, name='start'),
    ...
    # Выдача КР
    path('collections/<int:collection_id>/assign/', views.assign_collection, name='assign'),
